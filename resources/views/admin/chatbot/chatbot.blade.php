            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Auto Responses Management</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item"><a href="{{ route('admin.chatbot') }}">Chatbot</a></li>
                                <li class="breadcrumb-item active">Auto Responses</li>
                            </ol>
                            <div class="mt-2">
                                <a href="{{ route('admin.chatbot.ml') }}" class="btn btn-outline-primary btn-sm">
                                    <i class="bx bx-brain me-1"></i>Smart Responses
                                </a>
                            </div>
                        </div>
                    </div>
