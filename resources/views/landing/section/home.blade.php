                    ...
                    <div class="hero-text-wrap">
                        <div class="hero-text white-color">
                            <div class="container text-center">
                                ...
                                <h1 class="text-uppercase font-700 font-80px">Your Amazing Website</h1>
                                <h3 class="font-400">Start your journey with us.</h3>
                                <p class="text-center mt-30">
                                    <a class="btn btn-color btn-circle btn-animate" href="#">
                                        <span>Learn More <i class="icofont icofont-arrow-right"></i></span>
                                    </a>
                                    <a class="btn btn-outline-white btn-circle" href="#">Contact Us</a>
                                </p>
                            </div>
                        </div>
                    </div>
