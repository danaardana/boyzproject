...
<section class="white-bg pb-0" id="team">
      ...
      <div class="row mt-50">        
        ...
        @endphp
          <div class="col-md-3 col-sm-6 col-xs-12 wow fadeTop remove-padding" data-wow-delay="0.{{ $loop->iteration }}s">
            <div class="team-member-container gallery-image-hover"> <img src="{{ asset($extraData['image'] ?? 'landing/images/team/default.jpg') }}" class="img-responsive" alt="team-member">
